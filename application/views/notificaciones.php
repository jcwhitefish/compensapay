<div class="p-5" id="app">
    ...
    <ul class="collapsible">
        ...
        if(is_array($noti))
        {
            ...
            {
                echo '<li>
                        <div class="collapsible-header"><i class="material-icons">email</i><td>'.$value["title"].'<span style="position:absolute;right:30px;">'.date("d / m / Y", $value["create_at"]).'</span></div>
