        ...
        <div class="sidebar center-align">
            ...
            <ul>
                <ul class="icon-list">
                    ...
                    <?php echo sprintf('<li><a href="%s"><i class="material-icons%s">home</i></a></li>', base_url('inicio'), (strpos(current_url(), 'inicio')) ? ' icon-list-hover' : '');?>
                    ...
                    <?php echo sprintf('<li><a href="%s"><i class="material-icons%s">headset_mic</i></a></li>', base_url('soporte'), (strpos(current_url(), 'sopoorte')) ? ' icon-list-hover' : '');?>
