<div class="p-5">
    <div class="card esquinasRedondas">
        <div class="card-content especial-p">
            ...
            <p>Hola <?php echo $nombre;?>, bienvenido a <strong>Solve</strong> pay, hemos enviado un correo a <?php echo $correo;?>, por favor activa tu cuenta para poder ingresar a nuestra plataforma.</p><br>
