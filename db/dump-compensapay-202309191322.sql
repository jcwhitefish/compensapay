...
INSERT INTO `acceso` VALUES (1,1,_binary '��z*3>Y\nS3v\�\��','',0,NULL,1,NULL,NULL);
...
INSERT INTO `contacto` VALUES (1,_binary '�g\ny�ʖaۯ�\�U�Z',_binary '��\�60oԝh1.\�<{!',_binary 'Jc���\�\�\��',1),(2,_binary '\n\�\�aXz�\�O6Y\�',_binary '��\�60oԝh1.\�<{!',_binary '\�}\�C��\�Y��\�&≴��;\���L�;R\�Gp�',1);
...
INSERT INTO `cuentabacaria` VALUES (1,1,_binary '�\�\�:�X,B�l\�\�\�d���\�*V\�\�\�U0p�~N{',1),(2,1,_binary '\�dq`.�m\�H!�\�ԛ��P�\�c x�_\�',1);
...
INSERT INTO `demo_datos` VALUES (1,'Cadena a encriptar',_binary '�r�?���^\�\nL\0�\�]r��,)\��WK�xu��','Llave');
...
INSERT INTO `direccion` VALUES (1,1,'En la calle con el numero X','No conocida','','CDMX',6000,1);
...
INSERT INTO `persona` VALUES (1,_binary '�}\�\�\�\��j�qP8N',_binary '��\�C���HX�\�\�I\�̊\�*V\�\�\�U0p�~N{',_binary 'w$\�D\�\�r��l\���>�',_binary '\�}кf8�KK\r\�U\�\�',_binary '��\�60oԝh1.\�<{!',_binary '��\�60oԝh1.\�<{!',_binary '�yr�#F����D����',_binary '��\�60oԝh1.\�<{!',_binary '��\�60oԝh1.\�<{!',_binary '<*\0:?\�\�\�c5{�',1),(2,_binary 'G�\���p�.\�2��\�',_binary '��\�C���HX�\�\�I\�̼g\ny�ʖaۯ�\�U�Z',_binary '\�W\�f��P\�N�\�:m',_binary '\�6�ڒ\r\�Ę4X}.�\�4',_binary '��\�60oԝh1.\�<{!',_binary '��\�60oԝh1.\�<{!',_binary '�yr�#F����D����',_binary '��\�60oԝh1.\�<{!',_binary '��\�60oԝh1.\�<{!',_binary '<*\0:?\�\�\�c5{�',1);
...
INSERT INTO `preguntapersona` VALUES (1,1,1,_binary '\�\\1\\��G\�E��u!}�',1);
...
INSERT INTO `representantelegal` VALUES (1,_binary '9c�@X\�-�\�\�\�L��',_binary '\�n�?�a\�|���\�',_binary '��\�60oԝh1.\�<{!',1);
...
INSERT INTO `usuario` VALUES (1,_binary '��\�60oԝh1.\�<{!',_binary '2\�<+\�[��g��l ',_binary '\��\Z8�2\����\�y��\�\�a_p#\�l�\���\�*V\�\�\�U0p�~N{',_binary '��\�60oԝh1.\�<{!',_binary '�\nHXp�PX�P$\�қ�~\�?�\�;ΐz~���;\r',1);
...
DELIMITER $$
$$
CREATE DEFINER=`root`@`localhost` FUNCTION `AgregaPregunta`(entrada blob,
llave varchar(100)) RETURNS blob
begin
  	declare resultado blob;
  	declare contenido varchar(50);
...
begin
	...
	declare nombre varchar(30);
set
nombre = JSON_UNQUOTE(json_extract(entrada,'$.NombreRepresentante'));
...
DELIMITER $$
$$
CREATE DEFINER=`root`@`localhost` FUNCTION `AgregaUsuario`(entrada blob,llave varchar(100)) 
RETURNS blob
begin
...
DELIMITER $$
$$
CREATE DEFINER=`root`@`localhost` FUNCTION `ConsultaEmpresa`(entrada blob,llave varchar(100)) 
RETURNS blob
begin
...
DELIMITER $$
$$
CREATE DEFINER=`root`@`localhost` FUNCTION `ConsultaPersona`(entrada int,llave varchar(100))
RETURNS blob
begin
...
DELIMITER $$
$$
CREATE DEFINER=`root`@`localhost` FUNCTION `ConsutlarEstadosMX`() 
RETURNS blob
begin
  declare salida blob;
...
DELIMITER $$
$$
CREATE DEFINER=`root`@`localhost` FUNCTION `ExisteRFC`(entrada VARCHAR(20),llave varchar(100)) 
RETURNS blob
begin
...
DELIMITER $$
$$
CREATE DEFINER=`root`@`localhost` FUNCTION `ExisteUsuario`(entrada VARCHAR(50),llave varchar(100))
RETURNS int(1)
BEGIN
  DECLARE salida int;
...
DELIMITER $$
$$
CREATE DEFINER=`root`@`localhost` FUNCTION `UpdateLlaveUsuario`(entrada blob, llave varchar(100)) 
RETURNS blob
begin
	declare resultado blob;
...
DELIMITER $$
$$
CREATE DEFINER=`root`@`localhost` FUNCTION `ValidarLlave`(entrada blob,llave varchar(100)) 
RETURNS blob
begin
  declare resultado blob;
...
DELIMITER $$
$$
CREATE DEFINER=`root`@`localhost` FUNCTION `VerBanco`(entrada VARCHAR(4)) 
RETURNS varchar(100) 
...
DELIMITER $$
$$
CREATE DEFINER=`root`@`localhost` FUNCTION `VerCatPreguntas`() 
RETURNS blob
begin
	declare salida blob;
	select	
...
DELIMITER $$
$$
CREATE DEFINER=`root`@`localhost` FUNCTION `VerRegimenFiscal`(tipopersona int) 
RETURNS blob
begin
	declare salida blob;
	declare fisica int;
...
-- Dump completed on 2023-09-19 13:22:59
