...
CREATE DEFINER=`root`@`localhost` FUNCTION `AgregarOperacion` (`entrada` TEXT, `llave` VARCHAR(100)) RETURNS TEXT CHARSET utf8mb4  begin
	declare resultado text;
...
(4, 'Mw==', 'VXN1YXJpb0Ux', 'Tm9tYnJlIFVzdWFyaW9FMQ==', 'QXBlbGxpZG8gVXN1YXJpb0Ux', 'ZTEwYWRjMzk0OWJhNTlhYmJlNTZlMDU3ZjIwZjg4M2U=', 'MQ==', 'L3RlbXByYWwvaW1hZ2VuLnBuZw==', 1),
(5, 'NA==', 'VXN1YXJpb0Uy', 'Tm9tYnJlIFVzdWFyaW9FMg==', 'QXBlbGxpZG8gVXN1YXJpb0Uy', 'ZTEwYWRjMzk0OWJhNTlhYmJlNTZlMDU3ZjIwZjg4M2U=', 'MQ==', 'L3RlbXByYWwvaW1hZ2VuLnBuZw==', 1);
