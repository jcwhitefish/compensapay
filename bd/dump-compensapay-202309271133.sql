...
-- Tiempo de generación: 27-09-2023 a las 17:32:47
...
insert
	into
	compensapay.contacto (c_idTipoContacto,
	c_idPersona,
	c_Descripcion,
	c_Activo)
values
...
where
	from_base64(c_idTipoContacto) = idTipoContacto
	and 
	from_base64(c_idPersona) = idPersona
	and 
...
set
	p.per_idCtaBanco = to_base64(idcuenta)
where
...
insert into compensapay.contacto (
		c_idTipoContacto,
 		c_idPersona,
 		c_Descripcion,
 		c_Activo) 
...
update compensapay.cuentabancaria ct
set 
...
from
	compensapay.persona p
inner join compensapay.cuentabancaria c on
...
from
	compensapay.contacto c 
inner join compensapay.tipocontacto t on from_base64(c.c_idTipoContacto) = t.tc_idTipoContacto  
	where
...
--
-- Creación: 22-09-2023 a las 14:01:41
--
...
--
-- Creación: 21-09-2023 a las 21:11:22
--
...
--
-- Creación: 26-09-2023 a las 16:15:22
--
...
--
-- Creación: 22-09-2023 a las 14:03:06
--
...
--
-- Creación: 22-09-2023 a las 14:10:50
--
...
--
-- Creación: 22-09-2023 a las 14:05:32
--
...
--
-- Creación: 22-09-2023 a las 14:06:42
--
...
--
-- Creación: 22-09-2023 a las 14:07:06
--
...
--
-- Creación: 22-09-2023 a las 14:07:49
--
...
--
-- Creación: 22-09-2023 a las 14:09:20
--
...
-- Creación: 22-09-2023 a las 16:29:17
--
