...
INSERT INTO `cuentabacaria` VALUES (3,1,'�dq`.�m�H!��ԛ��P��c x�_�',1);
...
CREATE TABLE `usuario` (
  ...
  `u_Apellidos` varchar(100) DEFAULT NULL,
  `u_Llaveacceso` blob,
  `u_idPerfil` blob,
...
/*!50001 CREATE TABLE `vistapersonausuario` (
  `per_idPersona` tinyint NOT NULL,
  `per_Nombre` tinyint NOT NULL,
  `per_Alias` tinyint NOT NULL,
  `per_RFC` tinyint NOT NULL,
  `per_idTipoPrersona` tinyint NOT NULL,
  `per_idRol` tinyint NOT NULL,
  `per_ActivoFintec` tinyint NOT NULL,
  `per_Activo` tinyint NOT NULL,
  `rl_idRepresentante` tinyint NOT NULL,
  `rl_Nombre` tinyint NOT NULL,
  `rl_RFC` tinyint NOT NULL,
  `rl_idPersona` tinyint NOT NULL,
  `rl_Activo` tinyint NOT NULL,
  `u_idUsuario` tinyint NOT NULL,
  `u_idPersona` tinyint NOT NULL,
  `u_NombreUsuario` tinyint NOT NULL,
  `u_idPerfil` tinyint NOT NULL,
...
/*!50001 DROP TABLE IF EXISTS `vistapersonausuario`*/;
/*!50001 DROP VIEW IF EXISTS `vistapersonausuario`*/;
