...
INSERT INTO `persona` VALUES (1,'Q2xpZW50ZSBOb21icmU=','QXBlbGxpZG8gQ2xpZW50ZQ==','QWxpYXNDMg==','WFhYWEFBTU1ERFhY','MQ==','MQ==','MA==','MQ==','MQ==',NULL,1);
...
INSERT INTO `usuario` VALUES (1,'MQ==','RGVtb1VzZXI=','Tm9tYnJlIFVzZXI=','QXBlbGxpZG8gVXNlcg==','ZTEwYWRjMzk0OWJhNTlhYmJlNTZlMDU3ZjIwZjg4M2U=','MQ==','L3RlbXByYWwvaW1hZ2VuLnBuZw==',1);
...
DELIMITER ;;
CREATE  FUNCTION `AgregaContacto`(entrada text,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
CREATE  FUNCTION `AgregaCtaBancaria`(entrada text,llave varchar(100)) RETURNS text CHARSET utf8mb4
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
CREATE  FUNCTION `AgregaDireccion`(entrada text) RETURNS blob
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
CREATE  FUNCTION `AgregaPersona`(entrada text, llave varchar(100)) RETURNS text CHARSET utf8mb4
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
CREATE  FUNCTION `AgregaPregunta`(entrada text, llave varchar(100)) RETURNS blob
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
CREATE  FUNCTION `AgregaRepresentante`(entrada text, llave varchar(100)) RETURNS blob
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
CREATE  FUNCTION `AgregarOperacion`(entrada text, llave varchar(100)) RETURNS blob
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
CREATE  FUNCTION `AgregaUsuario`(entrada text,llave varchar(100)) RETURNS blob
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
CREATE  FUNCTION `ConsultaEmpresa`(entrada text, llave varchar(100)) RETURNS text CHARSET latin1
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
CREATE  FUNCTION `ConsultaPersona`(entrada int,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
CREATE  FUNCTION `ConsutlarEstadosMX`() RETURNS text CHARSET latin1
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
CREATE  FUNCTION `ExisteRFC`(entrada VARCHAR(20),llave varchar(100)) RETURNS text CHARSET latin1
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
CREATE  FUNCTION `ExisteUsuario`(entrada VARCHAR(50),llave varchar(100)) RETURNS int
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `UpdateContacto` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
CREATE  FUNCTION `UpdateContacto`(entrada text,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `UpdateDireccion` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
CREATE  FUNCTION `UpdateDireccion`(entrada text) RETURNS blob
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
CREATE  FUNCTION `UpdateLlaveUsuario`(entrada text, llave varchar(100)) RETURNS text CHARSET latin1
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
CREATE  FUNCTION `UpdatePersona`(entrada text,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `UpdateUsuario` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
CREATE  FUNCTION `UpdateUsuario`(entrada text,llave varchar(100)) RETURNS blob
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
CREATE  FUNCTION `ValidarLlave`(entrada text,llave varchar(100)) RETURNS text CHARSET latin1
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
CREATE  FUNCTION `VerBanco`(entrada VARCHAR(4)) RETURNS varchar(100) CHARSET utf8mb4
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
CREATE  FUNCTION `VerCatPreguntas`() RETURNS text CHARSET latin1
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
CREATE  FUNCTION `VerRegimenFiscal`(tipopersona int) RETURNS text CHARSET latin1
begin
...
-- Dump completed on 2023-09-25 13:34:04
